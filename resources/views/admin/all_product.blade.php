      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-product/'.$pro->product_id)}}" id="icon-category" class="active" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-success text-active"></i></a>
                <a onClick="return confirm('Bạn có chắc muốn xóa sản phẩm này ?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" id="icon-category" class="active" ui-toggle-class="">
